...
describe('contentValidator', () => {
  ...
  const { parseJsonContent, extractQuestionsArray } = require('../src/service/gemini/quiz/parsers');
  ...
  describe('validateGeneratedContent', () => {
    ...
    it('should throw error when JSON parsing fails', () => {
      ...
      expect(() => validateGeneratedContent(mockContent)).toThrow(
        'Invalid generated content: JSON parse error'
      );
    ...
    it('should throw error when questions extraction fails', () => {
      ...
      expect(() => validateGeneratedContent(mockContent)).toThrow(
        'Invalid generated content: No questions found'
      );
    ...
    it('should throw error when validation fails', () => {
      ...
      expect(() => validateGeneratedContent(mockContent)).toThrow(
        'Invalid generated content: Validation error'
      );
