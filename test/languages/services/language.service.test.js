  ...
  const testUpdateLanguage = () => {
    describe('updateLanguageService', () => {
      it('should update a language successfully', async () => {
        ...
        const updateLanguage = jest.spyOn(
          require('../../../src/repository/languageRepository'),
          'updateLanguage'
        );
