...
const { constructPrompt, DEFAULT_PROMPT_TEMPLATE } = require('../src/service/gemini/quiz/promptBuilder');
...
describe('promptBuilder', () => {
  ...
  describe('constructPrompt', () => {
    ...
    it('should use custom prompt template from environment variable', () => {
      ...
      const expected = 'Custom template for the topic of "React" with Focus on the "JavaScript" programming language. ';
